...
It is important to mention that the above list of facets is by no means exhaustive. Other factors are also very important in certain scenarios, such as non-repudiation or availability. However, this thesis focuses on protection measures offered directly by a given document format. Protecting information stored in electronic documents is a complex task with many pitfalls. Legal and social processes should be implemented to add another layer of security, besides technical concepts leveraging cryptography.  
